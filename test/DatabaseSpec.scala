...
class DatabaseSpec extends FlatSpec with Matchers with MockitoSugar with BeforeAndAfterAll {
  ...
  def populateDatabase(): Unit = {
    ...
    Suggestions += SuggestionsRow(1, "gazeta.pl", "gazeta.pl/galeria121312/asdasd", "UA Firefox",  "no i znowu cos nie dziala ;(", "test@test.com", "NOWY", timestamp, None)
    Issues += IssuesRow(1, "3.1.2-chrome", "http://gazeta.pl/gallery1", "UA Firefox", "nie dziala ;(", "test@test.com", "NOWY", timestamp, None)
  }
